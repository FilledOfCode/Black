...
You can use the tester.html file to control your Spark Core. Its not a great UI, but it lets you try out the inverse kinematics by specifying target positi